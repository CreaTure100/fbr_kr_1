  ...
  return (
    <div className="grid-2">
      <section className="card">
        ...
        <form onSubmit={onCreate} className="form-grid">
          ...
          <input
            name="image"
            type="text"
            placeholder="URL или путь /images/your-file.jpg (необязательно)"
      ...
      <section className="card">
        ...
        <button onClick={loadProducts} className="secondary-btn">Обновить список</button>
            ...
            {products.map((p) => (
              <li key={p.id} className="product-item">
                ...
                <div className="item-actions">
                  ...
                  <button className="danger-btn" onClick={() => onDelete(p.id)}>
                    Удалить
                  </button>
                </div>
              </li>
