 ...
 *     responses:
 *       201:
 *         description: Пользователь успешно создан. Пароль не возвращается.
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                   type: string
 *       401:
 *         description: Неавторизован (нужен токен или невалидный)
 *       404:
 ...
 *               title:
 *                 type: string
 *                 example: Игровая консоль
 *               category:
 *                 type: string
 *                 example: Электроника
 *               description:
 *                 type: string
 *                 example: Мощная игровая приставка с 4K графикой и 1TB памяти
 *               price:
 *                 type: number
 *                 example: 45999.99
 *     responses:
 ...
 *       400:
 *         description: Не все обязательные поля указаны
 *       404:
 *         description: Товар не найден
 */
app.put('/api/products/:id', authMiddleware, (req, res) => {
  ...
  const updatedProduct = {
    ...
    description,
    price,
    image: image || products[productIndex].image || 'https://via.placeholder.com/600x400?text=No+Image'
  };
